...
def search_function(search_term: str):
        ...
        with st.status(f"Searching for content using GraphRAG..."):
            ...
            context_information = RAGHandler.parse_query_response(search_result, return_context_data=True)
            sources = RAGHandler.extract_source_information(context_information)
        st.success("Search complete!")
        return "GraphRAG Result: " + results_parsed + "\nSources: \n\t" + sources
